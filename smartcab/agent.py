...
class LearningAgent(Agent):
	...
	#	self.epsilon = (1.995*self.alpha)**self.t
	#	self.epsilon = self.alpha**self.t
	#	self.epsilon = 1.0/self.t**2
		self.epsilon = math.exp(-0.008*self.t)
	...
	if self.learning:
		if not state in self.Q:
			...
			self.Q[state] = dict(zip(actions,len(actions)*[0.0]))
...
def run():
    ...
    #agent = env.create_agent(LearningAgent, learning=True, alpha=0.0025)
